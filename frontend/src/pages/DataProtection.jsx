...
const DataProtection = () => (
    <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <section className="mb-4">
            <p>
                NeuroAegis is committed to protecting user data according to international standards and regulations, including GDPR. We implement robust security measures, such as encryption and strict access controls, to protect personal data from unauthorized access, disclosure, or misuse.
            </p>
        </section>
        <section className="mb-4">
            <p>
